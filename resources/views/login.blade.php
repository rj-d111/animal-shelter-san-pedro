...
<body class="h-screen flex items-center justify-center">
    ...
    <div
        class="container bg-opacity-50 grid grid-cols-1 gap-y-5 lg:grid-cols-2 w-full py-10 rounded-lg">
        ...
        <div class="sm:w-4/5 px-3 mx-auto">
            ...
            <p class="">Let's have an adventure together with your pets</p>
            <form class="my-6">
                <div class="mb-4">
                    <input type="email" placeholder="Email"
                        class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-yellow-600">
                </div>
                <div class="mb-4 relative">
                    <input id="password" type="password" placeholder="Password"
                        class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-yellow-600 pr-10">
                    <button type="button" id="toggle-password"
                        ...
                        <svg id="eye-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M2.458 12C3.732 7.943 7.522 5 12 5c4.478 0 8.268 2.943 9.542 7-.474 1.528-1.314 2.88-2.395 3.956M15 12a3 3 0 00-6 0m6 0a3 3 0 01-6 0M12 19c-4.478 0-8.268-2.943-9.542-7C4.732 7.943 8.522 5 12 5c1.126 0 2.204.204 3.206.578" />
                        </svg>
                    </button>
                </div>
                <div class="flex items-center justify-center mb-4">
                    <a href="#" class="text-sm text-yellow-600 hover:underline">Don’t have an account?
                        Register</a>
                </div>
                <div class="flex items-center justify-center mb-4">
                    <a href="#" class="text-sm text-gray-600 hover:underline">Forgot
                        password?</a>
                </div>
                <div>
                    <button type="submit"
                        class="w-full px-4 py-2 text-white bg-yellow-600 rounded-md hover:bg-yellow-700 focus:outline-none focus:bg-yellow-700">LOG
                        IN</button>
                </div>
            </form>
