                ...
                <form class="my-6">
                    <div class="mb-4">
                        <input type="email" placeholder="Email"
                            class="dark:bg-slate-900 w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-yellow-600">
                    </div>
                    <div class="mb-4 relative">
                        <input id="password" type="password" placeholder="Password"
                            class="dark:bg-slate-900 w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-yellow-600 pr-10">
                    ...
                    <div class="flex items-center justify-center mb-4">
                        <a href="{{ url('register') }}" class="text-sm text-yellow-600 hover:underline">Don’t have an
                            account? Register</a>
                    </div>
                    <div class="flex items-center justify-center mb-4">
