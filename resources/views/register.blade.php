        ...
        <div
            ...
            <div class="sm:w-4/5 px-3 mx-auto">
                ...
                <form class="my-6" action="{{ route('register.submit') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="name" class="block font-bold mb-2 after:content-['\00a0*'] after:dark:text-red-400 after:text-red-600">Pet Owner Name</label>
                        <input type="text" id="name" name="name" placeholder="Full Name" class="dark:bg-slate-800 w-full px-3 py-2 border rounded" required>
                    </div>
                    <div class="mb-4">
                        <label for="email" class="block font-bold mb-2 after:content-['\00a0*'] after:dark:text-red-400 after:text-red-600">Email</label>
                        <input type="email" id="email" name="email" placeholder="Email" class="dark:bg-slate-800 w-full px-3 py-2 border rounded" required>
                    </div>
                    <div class="mb-4">
                        <label for="phone" class="block font-bold mb-2 after:content-['\00a0*'] after:dark:text-red-400 after:text-red-600">Contact No.</label>
                        <input type="tel" id="phone" name="phone" placeholder="Contact No." class="dark:bg-slate-800 w-full px-3 py-2 border rounded" required>
                    </div>
                    <label for="password" class="block font-bold mb-2 after:content-['\00a0*'] after:dark:text-red-400 after:text-red-600">Password</label>
                    <div class="mb-4 relative">
                        <input id="password" type="password" name="password" placeholder="Password" class="dark:bg-slate-800 w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-yellow-600 pr-10" required>
                    ...
                    <div class="mb-4">
                        <label for="confirm" class="block font-bold mb-2 after:content-['\00a0*'] after:dark:text-red-400 after:text-red-600">Confirm Password</label>
                        <input type="password" id="confirm" name="password_confirmation" placeholder="Confirm Password" class="dark:bg-slate-800 w-full px-3 py-2 border rounded" required>
                    </div>
                    <div class="flex items-center justify-center mb-4">
                        <a href="{{ url('login') }}" class="text-sm text-yellow-600 hover:underline">Already Registered? Login</a>
                    </div>
                    <div>
                        <button type="submit" class="w-full px-4 py-2 text-white bg-yellow-600 rounded-md hover:bg-yellow-700 focus:outline-none focus:bg-yellow-700">Register</button>
                    </div>
                </form>
